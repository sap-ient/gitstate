...
const CAPABILITIES = [
  ...
  },
  {
    ...
    accentRgb: '99,102,241',
    glowVariant: 'indigo',
    title: 'Plan against real availability.',
    subtitle: 'Capacity & PTO',
    body: 'Sprint planning against fictional "8 hours available" is how deadlines die. gitstate tracks capacity with PTO, part-time schedules, and carry-over baked in.',
    bullets: [
      'Per-builder daily availability calendar',
      'PTO and public holidays subtract automatically',
      'Carry-over from previous sprints always visible',
    ],
    shot: '/shots/capacity.png',
    shotUrl: 'app.gitstate.dev/capacity',
    shotAlt: 'gitstate capacity — PTO-aware sprint planning',
  },
  {
    icon: ReceiptText,
    accent: '#2DD4BF',
    accentRgb: '45,212,191',
    glowVariant: 'teal',
    title: 'Every invoice line has a commit.',
    subtitle: 'Evidence billing',
    body: 'Per-builder time, billed in USD, charged in your local currency. Every invoice line links to a commit SHA or PR — clients see exactly what was built.',
    bullets: [
      'Attach git evidence to every billable line item',
      'USD billed · ZAR / GBP / EUR charged at live rate',
      'Gaps flagged for manual fill — nothing invented',
    ],
    shot: '/shots/billing.png',
    shotUrl: 'app.gitstate.dev/billing',
    shotAlt: 'gitstate billing — evidence-backed invoices per builder',
  },
]
